              ...
              <div className="overflow-x-auto border border-gray-300 bg-white">
                <table className="w-full text-left border-collapse">
                  <thead className="bg-[#FFD966] text-black font-black text-center">
                    <tr>
                      <th className="px-1 py-0.5 border border-gray-300 text-sm sm:text-base leading-tight font-bold text-gray-900">Select</th>
                      <th className="px-1 py-0.5 border border-gray-300 text-sm sm:text-base leading-tight font-bold text-gray-900">Date</th>
                      ...
                      <th className="px-1 py-0.5 border border-gray-300 text-sm sm:text-base leading-tight font-bold text-gray-900">Sr. No.</th>
                      <th className="px-1 py-0.5 border border-gray-300 text-sm sm:text-base leading-tight font-bold text-gray-900">Net Wt.</th>
                    </tr>
                  </thead>
                  <tbody>
                    {activeProdRolls.map(roll => (
                      <tr key={roll.id} onClick={() => toggleTakenBySlitting(roll)}
                        ...
                        <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{formatToDDMM(roll.date)}</td>
                        <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{roll.shift || '-'}</td>
                        <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{roll.rollNo}</td>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {[...activeSlitRolls].reverse().map(roll => {
                      ...
                      return (
                        <tr key={roll.id} className="text-center hover:bg-gray-50">
                          ...
                          <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{roll.shift || '-'}</td>
                          <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{roll.rollNo}</td>
                          <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{formatWeight(roll.grossWeight)}</td>
                    ...
                    <tr className="bg-[#C6E0B4] text-black font-black text-center">
                      ...
                      <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{formatWeight(activeSlitRolls.reduce((sum, r) => sum + (r.grossWeight || 0), 0))}</td>
                      <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{formatWeight(activeSlitRolls.reduce((sum, r) => sum + (r.coreWeight || 0), 0))}</td>
                      <td className="px-1 py-0.5 border border-gray-300 font-mono text-sm sm:text-base leading-tight font-bold text-gray-900">{formatWeight(activeSlitRolls.reduce((sum, r) => sum + (r.netWeight || 0), 0))}</td>

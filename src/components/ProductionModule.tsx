  ...
  if (!selectedJobCard) {
    return (
      <div className="space-y-4 animate-fade-in">
        {prodRolls.filter(r => r.date === getTodayString()).length > 0 && (
        <div className="p-6 bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md rounded-[28px] mb-4">

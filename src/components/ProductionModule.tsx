          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white p-3 rounded-2xl border border-slate-200 shadow-xs">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs font-extrabold text-slate-800 uppercase tracking-wider">
                All Job Cards List for Production
              </h3>
            </div>
            ...
            <div className="flex items-center gap-2 flex-1 max-w-md">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-9 pr-8 py-1.5 text-xs font-medium text-slate-800 focus:bg-white focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                />
                {searchQuery && (
                  <button
